...
.SILENT all:
	...
	$(call perform_test,wrong,"Wrong format")
	$(call perform_test,big,"Big numbers")
	$(call perform_test,normal,"Normal/easy tests")
	$(call perform_test,bad,"Bad tests")
